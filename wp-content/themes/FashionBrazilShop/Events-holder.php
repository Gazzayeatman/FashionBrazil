            ...
            <div class="col-md-6">
                ...
                <div class="share">
                    ...
                    <ul class="share-social-icons">
                        <li><a target="_new" href="https://www.facebook.com/sharer/sharer.php?u=<?php echo get_the_title(); ?><?php echo $_SERVER['REQUEST_URI']; ?>&t=<?php echo get_the_title(); ?>"><i class="fa fa-facebook-square" aria-hidden="true"></i></a></li>
                        <li><a target="_new" href="https://plus.google.com/share?url=<?php echo get_the_title(); ?><?php echo $_SERVER['REQUEST_URI']; ?>"><i class="fa fa-google-plus-square" aria-hidden="true"></i></a></li>
