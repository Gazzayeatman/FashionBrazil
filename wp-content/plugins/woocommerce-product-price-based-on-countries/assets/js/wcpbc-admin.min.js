...
a("#general_coupon_data #discount_type").on("change",function(){a("#general_coupon_data #zone_pricing_type").closest("p").toggle("fixed_cart"==a(this).val()||"fixed_product"==a(this).val())});a(document).ready(function(){a('.wcpbc_sale_price_dates[type="radio"][value="manual"], .wcpbc_price_method[type="radio"][value="manual"]').each(function(){var b="."+a(this).attr("name")+"_field";b=b.replace("[","_");b=b.replace("]","");a(this).closest(b).next(".wcpbc_show_if_manual").toggle(a(this).prop("checked"))});
a("#general_coupon_data #zone_pricing_type").closest("p").toggle("fixed_cart"==a("#general_coupon_data #discount_type").val()||"fixed_product"==a("#general_coupon_data #discount_type").val());a("select.variation_actions").on("wcpbc_variable_bulk_edit_popup",function(b){tb_show("Upgrade to Price Based on Country Pro now!","#TB_inline?width=600&height=350&inlineId=variable-bulk-edit-popup",!1);a("#TB_window").css({width:"680px",height:"380px"});a("#TB_window .button.button-primary").focus()})});a("body").on("click",
"a.wcpbc-delete-zone",function(a){confirm(wc_price_based_country_admin_params.i18n_delete_zone_alert)||a.preventDefault()});a("body").on("click","input#wc_price_based_country_caching_support",function(){a(this).is(":checked")&&alert(wc_price_based_country_admin_params.i18n_caching_support_alert)});a(document).ready(d);a(document.body).on("woocommerce-product-type-change",d);a(document.body).on("woocommerce_variations_added",d);a("#woocommerce-product-data").on("woocommerce_variations_loaded",d);a(".notice-pbc a.pbc-hide-notice").on("click",
function(b){b.preventDefault();var c=a(this).closest(".notice-pbc");a(c).find(".pbc-wait").remove();a(c).append('<div class="pbc-wait"></div>');if(0<a(".notice-pbc.updating").length){var d=a(this);setTimeout(function(){d.triggerHandler("click")},100);return!1}a(c).addClass("updating");a.post(wc_price_based_country_admin_params.ajax_url,{action:"wcpbc_hide_notice",security:a(this).data("nonce"),notice:a(this).data("notice"),remind:a(this).hasClass("remind-later")?"yes":"no"},function(){a(c).removeClass("updating");
a(c).fadeOut(100)})});a(".wc-price-based-country-setting-wrapper-ads .wc-price-based-country-setting-content").append(a("p.submit"))});