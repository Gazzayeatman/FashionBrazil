	...
	public static function variable_bulk_edit_popup(){
		 ...
		 ?>
		 	<div id="variable-bulk-edit-popup" style="display:none;">
		 		...
		 		<a target="_blank" rel="noopener noreferrer" class="button button-primary" href="https://www.pricebasedcountry.com/pricing/?utm_source=bulk-edit&utm_medium=banner&utm_campaign=Get_Pro"><?php _e( 'Upgrade to Price Based on Country Pro now!', 'wc-price-based-country' ); ?></a>
		 	</div>
		 <?php
	}
