<?php
/**
 * Additional WooCommerce Functions used by plugins
 */
...
if ( ! function_exists( 'woothemes_queue_update' ) ) {
	/**
	 * Checking the WooCommerce Update Queue
	 * @param File 	$file 
	 * @param int 	$file_id
...
if ( ! class_exists( 'WooThemes_Updater' ) && ! function_exists( 'woothemes_updater_install' ) ) {
	/**
	 * Checking the WooCommerce Updater Install
	 * @param API 		$api 	
	 * @param string 	$action
	 * @param object 	$args
	 * @return API
...
if ( ! class_exists( 'WooThemes_Plugin_Updater' ) ) {
	...
	/**
	 * Initialise the WooThemes Plugin Uodater 
	 * @return void
	 */
